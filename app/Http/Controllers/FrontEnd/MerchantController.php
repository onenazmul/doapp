...
class MerchantController extends Controller
{
    ...
    public function dashboard(){
          ...
          $merchantUnPaid=Parcel::where('merchantId',Session::get('merchantId'))->where('status',4)->sum('merchantDue');
          $merchantPaid=Parcel::where('merchantId',Session::get('merchantId'))->where('status',4)->sum('merchantPaid');
          $deliveryCharge=Parcel::where('merchantId', Session::get('merchantId'))->where('status',4)->sum('deliveryCharge');
          $codCharge=Parcel::where('merchantId', Session::get('merchantId'))->where('status',4)->sum('codCharge');
          return view('frontEnd.layouts.pages.merchant.dashboard',compact('placepercel','deliveryCharge','codCharge','pendingparcel','deliverd','parcelreturn','cancelparcel','totalhold','totalamount','merchantUnPaid','merchantPaid'));
    }
    // Merchant Dashboard
