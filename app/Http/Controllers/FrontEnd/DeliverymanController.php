...
class DeliverymanController extends Controller
{
  ...
  public function report(Request $request){
    if ($request->startDate) {
      ...
      $parcelr =Parcel::where('deliverymanId',Session::get('deliverymanId'))->where('status',4)->whereBetween('present_date', [$request->startDate, $request->endDate])->count();
      $parcelc =Parcel::where('deliverymanId',Session::get('deliverymanId'))->where('status',9)->whereBetween('present_date', [$request->startDate, $request->endDate])->count();
      $parcelre =Parcel::where('deliverymanId',Session::get('deliverymanId'))->where('status',8)->whereBetween('present_date', [$request->startDate, $request->endDate])->count();
      $parcelpa =Parcel::where('deliverymanId',Session::get('deliverymanId'))->where('status',1)->whereBetween('present_date', [$request->startDate, $request->endDate])->count();
    
      $parcelpictd =Parcel::where('deliverymanId',Session::get('deliverymanId'))->where('status',2)->whereBetween('present_date', [$request->startDate, $request->endDate])->count();
      $parcelinterjit =Parcel::where('deliverymanId',Session::get('deliverymanId'))->where('status',3)->whereBetween('present_date', [$request->startDate, $request->endDate])->count();
      $parcelhold =Parcel::where('deliverymanId',Session::get('deliverymanId'))->where('status',5)->whereBetween('present_date', [$request->startDate, $request->endDate])->count();
      $parcelrrtupa =Parcel::where('deliverymanId',Session::get('deliverymanId'))->where('status',6)->whereBetween('present_date', [$request->startDate, $request->endDate])->count();
      $parcelrrhub =Parcel::where('deliverymanId',Session::get('deliverymanId'))->where('status',7)->whereBetween('present_date', [$request->startDate, $request->endDate])->count();
    
      $parcelpriceCOD =Parcel::where('deliverymanId',Session::get('deliverymanId'))->where('status','!=',9)->whereBetween('present_date', [$request->startDate, $request->endDate])->sum('cod');
    // dd($parcelprice);
      $deliveryCharge= $parcelprice =Parcel::where('deliverymanId',Session::get('deliverymanId'))->whereBetween('present_date', [$request->startDate, $request->endDate])->sum('deliveryCharge');
    
      $codCharge= $parcelprice =Parcel::where('deliverymanId',Session::get('deliverymanId'))->whereBetween('present_date', [$request->startDate, $request->endDate])->sum('codCharge');
    
      $Collectedamount =Parcel::where('deliverymanId',Session::get('deliverymanId'))->where('status',4)->whereBetween('present_date', [$request->startDate, $request->endDate])->sum('cod');
    
      $parcelcount =Parcel::where('deliverymanId',Session::get('deliverymanId'))->whereBetween('present_date', [$request->startDate, $request->endDate])->count();
    ...
    // dd($parcelprice);
      $deliveryCharge =Parcel::where('deliverymanId',Session::get('deliverymanId'))->sum('deliveryCharge');
    
      $codCharge= Parcel::where('deliverymanId',Session::get('deliverymanId'))->sum('codCharge');
    
      $Collectedamount =Parcel::where('deliverymanId',Session::get('deliverymanId'))->where('status',4)->sum('cod');
