  ...
  public function transaction_deliveryman(){
    ...
    public function parcel(Request $request){
      ...
      // dd($parcelprice);
        ...
        $parcelinterjit =Parcel::where('agentId',Session::get('agentId'))->where('status',3)->where('trackingCode',$request->trackId)->where('recipientPhone',$request->phoneNumber)->whereBetween('created_at', [$request->startDate, $request->endDate])->count();
        ...
        $parcelpriceCOD =Parcel::where('agentId',Session::get('agentId'))->where('status','!=',9)->where('trackingCode',$request->trackId)->where('recipientPhone',$request->phoneNumber)->whereBetween('created_at', [$request->startDate, $request->endDate])->sum('cod');
      // dd($parcelprice);
        ...
        $codCharge= $parcelprice =Parcel::where('agentId',Session::get('agentId'))->where('trackingCode',$request->trackId)->where('recipientPhone',$request->phoneNumber)->whereBetween('created_at', [$request->startDate, $request->endDate])->sum('codCharge');
      
        $Collectedamount =Parcel::where('agentId',Session::get('agentId'))->where('status',4)->where('trackingCode',$request->trackId)->where('recipientPhone',$request->phoneNumber)->whereBetween('created_at', [$request->startDate, $request->endDate])->sum('cod');
      
        $parcelcount =Parcel::where('agentId',Session::get('agentId'))->where('trackingCode',$request->trackId)->where('recipientPhone',$request->phoneNumber)->whereBetween('created_at', [$request->startDate, $request->endDate])->count();
        $allparcel = DB::table('parcels')
        ->join('merchants', 'merchants.id','=','parcels.merchantId')
        ->where('parcels.agentId',Session::get('agentId'))
        ->where('parcels.recipientPhone',$request->phoneNumber)
      ...
      return view('frontEnd.layouts.pages.agent.parcels',compact('allparcel','aparceltypes','parcelr','parcelc','parcelre','parcelpa','parcelpictd','parcelinterjit','parcelhold','parcelrrtupa','parcelrrhub','parcelpriceCOD','deliveryCharge','codCharge','Collectedamount','parcelcount','dates','datee'));
  }
   public function parcels(Request $request){
      ...
      // dd($parcelprice);
       ...
       ->paginate(150);
            ...
            $parcelr =Parcel::where('agentId',Session::get('agentId'))->where('status',4)->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->count();
        $parcelc =Parcel::where('agentId',Session::get('agentId'))->where('status',9)->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->count();
        $parcelre =Parcel::where('agentId',Session::get('agentId'))->where('status',8)->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->count();
        $parcelpa =Parcel::where('agentId',Session::get('agentId'))->where('status',1)->whereBetween('created_at', [$request->startDate, $request->endDate])->count();
      
        $parcelpictd =Parcel::where('agentId',Session::get('agentId'))->where('status',2)->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->count();
        $parcelinterjit =Parcel::where('agentId',Session::get('agentId'))->where('status',3)->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->count();
        $parcelhold =Parcel::where('agentId',Session::get('agentId'))->where('status',5)->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->count();
        $parcelrrtupa =Parcel::where('agentId',Session::get('agentId'))->where('status',6)->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->count();
        $parcelrrhub =Parcel::where('agentId',Session::get('agentId'))->where('status',7)->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->count();
      
        $parcelpriceCOD =Parcel::where('agentId',Session::get('agentId'))->where('status','!=',9)->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->sum('cod');
      // dd($parcelprice);
        $deliveryCharge= $parcelprice =Parcel::where('agentId',Session::get('agentId'))->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->sum('deliveryCharge');
      
        $codCharge= $parcelprice =Parcel::where('agentId',Session::get('agentId'))->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->sum('codCharge');
      
        $Collectedamount =Parcel::where('agentId',Session::get('agentId'))->where('status',4)->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->sum('cod');
      
        $parcelcount =Parcel::where('agentId',Session::get('agentId'))->where('parcels.status',$aparceltypes->id)->whereBetween('created_at', [$request->startDate, $request->endDate])->count();
        $allparcel = DB::table('parcels')
        ->join('merchants', 'merchants.id','=','parcels.merchantId')
