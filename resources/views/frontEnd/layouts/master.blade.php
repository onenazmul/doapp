 ...
 <head>
    ...
    <meta property="og:image" content="/frontEnd/images/flingex_og.jpeg" />
    ...
    <meta name="twitter:image" content="/frontEnd/images/twitter.png">
    ...
    <!--<meta name="twitter:creator" content="@USERNAME">-->
     ...
     <!--@endforeach-->
     <!--====== Favicon Icon ======-->
     <link rel="apple-touch-icon" sizes="57x57" href="/frontEnd/images/icon/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="/frontEnd/images/icon/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="/frontEnd/images/icon/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="/frontEnd/images/icon/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="/frontEnd/images/icon/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="/frontEnd/images/icon/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="/frontEnd/images/icon/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="/frontEnd/images/icon/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="/frontEnd/images/icon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192"  href="/frontEnd/images/icon/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/frontEnd/images/icon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="/frontEnd/images/icon/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/frontEnd/images/icon/favicon-16x16.png">
    <link rel="manifest" href="/frontEnd/images/icon/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="/frontEnd/images/icon/ms-icon-144x144.png">
             ...
             <div class="container">
                 <div class="row">
                     ...
                     <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
                         <div class="widget">
                             <h3 class="footer-logo"><img src="{{asset('frontEnd')}}/assets/img/logo.png" alt=""></h3>
...
-->
 ...
 <!--     <div id="preloader">
         <div class="loader" id="loader-1">
             <img src="{{asset('frontEnd')}}/assets/img/preloader.png" alt="">
         </div>
     </div> -->
