						  ...
						  <div class="modal-dialog modal-lg" role="document">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						          <thead>
						              <tr>
						                  <td>Excel File Column Instruction <a href="{{asset('frontEnd/images/example.xlsx')}}" download> (Template ) </a></td>
						              </tr>
						          </thead>
						 ...
						 <div class="fraud-search">
								...
								@endphp
									<div class="row">
										...
										<div class="col-sm-6">
								           <div class="form-group">
												<input type="number" class="calculate weight form-control{{ $errors->has('weight') ? ' is-invalid' : '' }}" value="{{ old('weight') }}" name="weight" placeholder="Weight" required>
										    </div>
								       </div>
