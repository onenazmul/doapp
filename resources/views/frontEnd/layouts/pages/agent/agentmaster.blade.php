...
<head>
    ...
    <!-- //Meta tag Keywords -->
    <link rel="shortcut icon" type="image/jpg" href="https://flingex.com/frontEnd/images/icon/favicon-32x32.png"/>
    <!-- Custom-Files -->
      ...
      <div class="dash-sidebar no-print">
            ...
            <div class="profile-inner">
                <div class="profile-pic">
                    <a href="#"><img src="{{asset('frontEnd')}}/images/avator.png" alt=""></a>
                </div>
                        ...
                        <div class="heading-right">
                            ...
                            <!--    </li>-->
                                <li class="profile-area">
                                    <div class="profile">
                                        <a class="" ><img src="{{asset('frontEnd')}}/images/avator.png" alt="" >
