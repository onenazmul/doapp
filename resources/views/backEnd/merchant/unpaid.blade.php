                            ...
                            <table id="exampled" class="table table-bordered table-striped custom-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$value->companyName}}  <?php $upaid=App\Parcel::where('merchantId',$value->merchantId)->where('merchantpayStatus',null) ->whereIn('parcels.status',[4,8])->count(); ?> @if($upaid)<span class="btn btn-sm btn-danger">unpaid({{$upaid}})</span>@endif</td>
